...
namespace JBtje\Passports\Bridge;

use Illuminate\Contracts\Events\Dispatcher;
use JBtje\Passports\Events\RefreshTokenCreated;
use JBtje\Passports\RefreshTokenRepository as PassportRefreshTokenRepository;
