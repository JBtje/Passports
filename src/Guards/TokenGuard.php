...
namespace JBtje\Passports\Guards;
...
use JBtje\Passports\PassportUserProvider;
use JBtje\Passports\TokenRepository;
use JBtje\Passports\TransientToken;
...
class TokenGuard
{
     ...
     *
     * @var \JBtje\Passports\PassportUserProvider
     */
    protected $provider;
     ...
     * @param  \JBtje\Passports\PassportUserProvider  $provider
     * @param  \JBtje\Passports\TokenRepository  $tokens
